...
function mobileMenu() {
  ...
  if (menu.style.width === "100%") {
    ...
    /* Hvis #mobile_overlay har en width på 100%, sættes dens width til 0, hvilket for mobil menuen 
    til at forsvinde, og body får overflow = "visible", hvilket gør at man kan scoll på siden */
    menu.style.width = "0";
    body.style.overflow = "visible";
  } else {

    /* Hvis #mobile_overlay har en width på 0, sættes dens width til 100%, hvilket for mobil menuen 
    til at blive vist og body får overflow = "hidden", hvilket gør at man ikke kan scoll på siden */
...
window.addEventListener("scroll", () => {
  ...
  // Checker om "opacity" er over 0.6 og hvis den er bliver den sat til 0.6. Det gør at siden ikke bliver for mørk på lange sider.
  if (opacity > 0.6) {
    opacity = 0.6;
  }
  ...
  /* Opdatere alpha værdien for #background_darkener's baggrundsfarve til værdien gemt i "opacity". 
